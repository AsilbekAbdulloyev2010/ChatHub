...
const GOOGLE_API_KEY = "AIzaSyBSZ4WDimKa8EELOIbZ6mhcxU4rCiaF-gU";
    ...
    savedConversations.forEach((conversation) => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="https://cdn-icons-png.flaticon.com/512/266/266033.png" alt="User avatar">
        ...
        const responseText =
            conversation.apiResponse?.candidates?.[0]?.content?.parts?.[0]
                ?.text;
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="ai logo remove background.png" alt="Gemini avatar">
...
const displayLoadingAnimation = () => {
    const loadingHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="http://127.0.0.1:5500/gemini/ai%20logo%20remove%20background.png" alt="Gemini avatar">
            <p class="message__text"></p>
